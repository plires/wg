			...
			<section id="formulario" data-aos="fade-up" class="container formulario">
				<div class="row">
					...
					<div class="col-lg-6 datos">
						<p>
							La póliza Integral de Comercio cubre aquellos riesgos dedicados a actividades comerciales y de servicio. 
							A continuación encontrarás las coberturas disponibles que podrás incorporar de acuerdo con tus necesidades:
						</p>
