        ...
        <!-- Header-->
          <tr>
              <td style="vertical-align: middle;">
                  ...
                  <img src="https://librecomunicacion.net/clientes/sitio/img/email/header2.jpg" style="margin:0; padding:0; border:none; display:block; width: 100%; height: auto;" border="0" alt="header" />
          ...
          <!-- Texto-->
          <tr style="background-color: #0f649d;">
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; color: #575756; text-align: left; font-weight: 400;">
                    Desde {name_client} queremos agradecer tu registro. En poco tiempo comenzarás a recibir nuestras ofertas y novedades.
                  </p>
                  <br>
                  <br>
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>Nombre:</strong> {name_client}
                  </p>

                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>Nuestro email:</strong> {email_client}
                  </p>

                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>Nuestro tel&eacute;fono:</strong> {tel_client}
                  </p>

                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>Nuestro whatsapp:</strong> {wap_client}
                  </p>
          ...
          <!-- Boton : BEGIN -->
          <tr style="background-color: #0f649d;">
              <td style="background-color: #0f649d; text-align: center; padding: 40px;">
