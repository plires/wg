...
<head>
	...
	<meta name="description" content="Seccion sobre seguros patrimoniales Robo en Via Pública. Tambien contamos con Seguros de Agro, de vida y otros patrimoniales.">
	<title>WGSA Seguros de Agro, Patrimoniales y Vida - Robo en Via Pública</title>
	...
	<section id="content" class="transition patrimoniales_enlatados">
		...
		<section class="container-fluid p-0 header">
			<div data-aos="fade-right" class="content_h1">
				<img class="img-fluid" src="./img/seguro-patrimoniales/enlatados/icono-robo-via-publica.png" alt="icono seguro patrimoniales movilidad">
				<h1>Robo en<br>vía pública</h1>
			</div>
		</section>
		<!-- Header end -->
		...
		<section class="container costos">
			...
			<div class="row">
				<div data-aos="fade-up" class="col-md-12">
					<h2>LLEVÁ TUS COSAS CON TRANQUILIDAD <br>A TU BOLSO Y A LO QUE LLEVÁS, <br>MEJOR TENERLO PROTEGIDO.</h2>
				</div>
			</div>
			...
			<div class="row">
				<div data-aos="fade-up" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="plan_costo">
						<p>A partir de<br><span>$ 263</span><br>por mes</p>
					</div>
					...
					<div class="contenido">
						...
						<p class="parrafo_desc">
							Robo de bolso / billetera<br>
							<span>5.000</span>
						</p>

						<p class="parrafo_desc">
							Contenido de cartera<br>
							<span>5.000</span>
						</p>
				...
				<div data-aos="fade-up" data-aos-delay="50" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="plan_costo">
						<p>A partir de<br><span>$ 455</span><br>por mes</p>
					</div>
				...
				<div data-aos="fade-up" data-aos-delay="100" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="plan_costo">
						<p>A partir de<br><span>$ 1972</span><br>por mes</p>
					</div>
				...
				<div data-aos="fade-up" data-aos-delay="150" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="formulario_desplegable transition">
						<form 
							id="form_seguros_robo_via_custom" 
							method="post" 
							class="forms" 
							action="./php/validate-form-seguros-patrimoniales.php">
