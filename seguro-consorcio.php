...
<?php 
	...
	$selects = new Selects();
	$segurosTipo = $selects->getValues('./seguros_consorcio.json');
?>
...
<head>
	...
	<meta name="description" content="Seccion sobre seguros patrimoniales consorcio. Tambien contamos con Seguros de Agro, de vida y otros patrimoniales.">
	<title>WGSA Seguros de Agro, Patrimoniales y Vida - Consorcio</title>
	...
	<section id="content" class="transition patrimoniales_enlatados">
		...
		<section class="container-fluid p-0 header">
			<div data-aos="fade-right" class="content_h1">
				<img class="img-fluid" src="./img/seguro-patrimoniales/enlatados/icono-consorcio.png" alt="icono seguro patrimoniales Consorcio">
				<h1>Consorcio</h1>
			</div>
		</section>
		<!-- Header end -->
			...
			<section id="formulario" data-aos="fade-up" class="container formulario">
				<div class="row">
					...
					<div class="col-lg-6 datos">
						<p>
							A través de nuestro Seguro Integral de Consorcio ponemos a tu disposición una amplia gama de coberturas pensadas para cubrir las necesidades de tu edificio en una misma póliza.
	            ...
	            novalidate>
							...
							<h4>Cotizá tu seguro ahora</h4>
								...
								<input type="hidden" name="seguro" value="Consorcio">
