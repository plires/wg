...
<?php 
	...
	$selects = new Selects();
	$segurosTipo = $selects->getValues('./seguros_transporte.json');
?>
...
<head>
	...
	<meta name="description" content="Seccion sobre seguros patrimoniales Transporte. Tambien contamos con Seguros de Agro, de vida y otros patrimoniales.">
	<title>WGSA Seguros de Agro, Patrimoniales y Vida - Transporte</title>
	...
	<section id="content" class="transition patrimoniales_enlatados">
		...
		<section class="container-fluid p-0 header">
			<div data-aos="fade-right" class="content_h1">
				<img class="img-fluid" src="./img/seguro-patrimoniales/enlatados/icono-transporte.png" alt="icono seguro patrimoniales transporte">
				<h1>Transporte</h1>
			</div>
		</section>
		<!-- Header end -->
			...
			<section id="formulario" data-aos="fade-up" class="container formulario">
				<div class="row">
					...
					<div class="col-lg-6 datos">
						<p>
							Aseguramos la integridad de las mercaderías transportadas desde el origen hasta el destino, incluidas las paradas intermedias.
							Cubrimos las necesidades específicas de cada negocio dependiendo del mercado en el que se desarrollen las actividades de nuestros clientes. Los productos disponibles son:
						</p>

						<ul>
							<li>Terrestre dentro del territorio de</li>
							<li>la República Argentina </li>
							<li>Importación</li>
							<li>Exportación</li>
							<li>Integral</li>
						</ul>
	            ...
	            novalidate>
							...
							<h4>Cotizá tu seguro ahora</h4>
								...
								<input type="hidden" name="seguro" value="Transporte">
