	...
	<section id="content" class="transition patrimoniales_enlatados">
		...
		<section class="container-fluid p-0 header extra">
			<div data-aos="fade-right" class="content_h1">
				<img class="img-fluid" src="./img/seguro-patrimoniales/enlatados/icono-accidentes-domesticos.png" alt="icono seguro patrimoniales accidentes personales domesticos">
				<h1>Accidentes <br>personales <br>domésticos</h1>
			</div>
		</section>
		<!-- Header end -->
		...
		<section class="container costos">
			...
			<div class="row">
				<div data-aos="fade-up" class="col-md-12">
					<h2>LA IMPORTANCIA DE <br>TENER UNA PROTECCIÓN <br>ANTE IMPREVISTOS</h2>
				</div>
			</div>
			...
			<div class="row">
				<div data-aos="fade-up" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="formulario_desplegable transition">
						<form 
							id="form_seguros_accidente_domest_01" 
							method="post" 
							class="forms" 
							action="./php/validate-form-seguros-patrimoniales.php">

							<input type="hidden" name="plan" value="01">
							<input type="hidden" name="seguro" value="Accidentes Personales Domesticos">
				...
				<div data-aos="fade-up" data-aos-delay="50" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="plan_costo">
						<p>A partir de<br><span>$ 409</span><br>por mes</p>
					</div>
					...
					<div class="formulario_desplegable transition">
						<form 
							id="form_seguros_accidente_domest_02" 
							method="post" 
							class="forms" 
							action="./php/validate-form-seguros-patrimoniales.php">
				...
				<div data-aos="fade-up" data-aos-delay="100" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="plan_costo">
						<p>A partir de<br><span>$ 550</span><br>por mes</p>
					</div>
					...
					<div class="formulario_desplegable transition">
						<form 
							id="form_seguros_accidente_domest_03" 
							method="post" 
							class="forms" 
							action="./php/validate-form-seguros-patrimoniales.php">
				...
				<div data-aos="fade-up" data-aos-delay="150" class="col-12 col-md-6 col-lg-3 plan">
					...
					<div class="formulario_desplegable transition">
						<form 
							id="form_seguros_accidente_domest_custom" 
							method="post" 
							class="forms" 
							action="./php/validate-form-seguros-patrimoniales.php">
