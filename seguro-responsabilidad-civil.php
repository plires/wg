...
<?php 
	...
	$selects = new Selects();
	$segurosTipo = $selects->getValues('./seguros_responsabilidad_civil.json');
?>
...
<head>
	...
	<meta name="description" content="Seccion sobre seguros patrimoniales Responsabilidad Civil. Tambien contamos con Seguros de Agro, de vida y otros patrimoniales.">
	<title>WGSA Seguros de Agro, Patrimoniales y Vida - Responsabilidad Civil</title>
	...
	<section id="content" class="transition patrimoniales_enlatados">
		...
		<section class="container-fluid p-0 header">
			<div data-aos="fade-right" class="content_h1">
				<img class="img-fluid" src="./img/seguro-patrimoniales/enlatados/icono-responsabilidad-civil.png" alt="icono seguro patrimoniales responsabilidad civil">
				<h1>Responsabilidad<br>Civil</h1>
			</div>
		</section>
		<!-- Header end -->
			...
			<section id="formulario" data-aos="fade-up" class="container formulario">
				<div class="row">
					...
					<div class="col-lg-6 datos">
						<p>
							Mantenemos indemne tu patrimonio, resguardándolo de daños o lesiones ocasionados a terceros. 
							Estaremos junto a vos para que puedas desarrollar tu actividad con la tranquilidad que necesitas. 
							Contamos con un equipo profesional y una amplia gama de soluciones para satisfacer necesidades específicas.
						</p>

						<ul>
							<li>RC Construcción</li>
							<li>RC Operaciones y Producciones</li>
						</ul>
					</div>
